...
class perhitunganmatriks{
public static void main(String args[]){
	int pil, x, y, a, b, i, j;
    Scanner input = new Scanner(System.in);

System.out.println("Ini adalah program untuk melakukan operasi perhitungan matriks");
...
pil = input.nextInt();
  ...
  System.out.print("Masukan baris matriks A: ");int baris1 = input.nextInt();
  System.out.print("Masukan kolom matriks A : ");int kolom1 = input.nextInt();
  System.out.println();
  System.out.print("Masukan baris matriks B: ");int baris2 = input.nextInt();
  System.out.print("Masukan kolom matriks B : ");int kolom2 = input.nextInt();
