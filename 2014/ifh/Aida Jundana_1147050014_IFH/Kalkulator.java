...
class kalkulator{
 ...
 public static void main (String arg[]){ 			//static > Static dan arg > args // ditambahkan public
	int a,s;
	...
	a=input.nextInt();
	System.out.print ("Masukkan angka kedua :"); 				//System.out.prInt > System.out.print // pertama > kedua
	s=input.nextInt();
	calc.tambah(a,s);
