...
System.out.println("Selamat Datang Untuk Program Perhitungan Matriks");
System.out.println("Syarat Ketentuan: ");
System.out.println("- Untuk penjumlahan dan pengurangan matriks hanya bisa menjumlahkan dan  mengurangkan baris matriks A=B dan kolom matriks A=B");
System.out.println("- Untuk perkalian hanya bisa mengalikan matriks berordo 2x2 dikali 2x3");
...
switch(pill){
  ...
  if(baris1==baris2 && kolom1==kolom2){
	...
	System.out.println();
	System.out.println("Langkah Perhitungan Matriks A+B");
	for (x= 0; x <baris1; x++){
	System.out.print("|");
		for (y = 0; y <kolom1; y++){
	...
	System.out.println("Ordo matriks tidak sesuai syarat ketentuan yang ada!!");
	}
    break;
  ...
  System.out.println("Anda akan melakukan operasi perkalian matriks");
	for(x=0; x<baris1;x++){
		for(y=0; y<kolom1;y++){
		System.out.print("matriks A ["+(x+1)+"]["+(y+1)+"] : ");
		matriks1[x][y]=input.nextInt();
	...
	System.out.println("Program Error!!");
	System.out.println("Ordo matriks tidak sesuai sayarat ketentuan yang ada!!");
	}
    break;
  }
}
